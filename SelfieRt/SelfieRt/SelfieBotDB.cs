...
namespace SelfieRt
{
    ...
    public class BotSqliteConnect
    {
        ...
        const string WaitRecognizer = "CREATE TABLE `WaitRecognizer` (`UID`	varchar(100) NOT NULL,`TID`	varchar(100) NOT NULL,`PhotoPath`	varchar(100),`PhotoUrl`	varchar(100),PRIMARY KEY(`PhotoUrl`));";
        ...
        public static void CreateDB_TABLE()
        {
        ...
        {
            return new SqliteConnection(config.DBConnectString);
        }
